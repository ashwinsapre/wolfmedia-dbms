...
public class Op16 {
	public int exec(Connection conn, Scanner paramscanner, String ARTISTID){
		ResultSet rs = null;
		try {
			String paramlist[] = {"COUNTRY", "PRIMARYGENRE"};
			...
			String updateString = "UPDATE ARTIST SET ";
			...
			updateString = updateString.substring(0, updateString.length()-1) + " WHERE ARTISTID="+Integer.parseInt(ARTISTID)+" ;";
