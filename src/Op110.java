...
public class Op110 {
	public int exec(Connection conn, Scanner paramscanner, String ALBUMID){
		ResultSet rs = null;
		try {
			String paramlist[] = {"NAME", "EDITION"};
			...
			String updateString = "UPDATE ALBUM SET ";
			...
			updateString = updateString.substring(0,updateString.length()-1) + " WHERE ALBUMID="+Integer.parseInt(ALBUMID)+" ;";
