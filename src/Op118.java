...
public class Op118 {
	public int exec(Connection conn, Scanner paramscanner, String PODCASTID){
		ResultSet rs = null;
		try {
			String paramlist[] = {"GENRES", "SPONSORS"};
			...
			String updateString = "UPDATE PODCAST SET ";
			...
			updateString = updateString.substring(0, updateString.length()-1) + " WHERE PODCASTID="+Integer.parseInt(PODCASTID)+" ;";
